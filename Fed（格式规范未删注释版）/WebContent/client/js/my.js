...
function changeSecond() {
	...
	if (svalue == 0) {
		...
		location.href = window.location.protocol + '//' + window.location.host + '/'+ webName + '/client/RegisterLogin.jsp'; 
		//location.href=location.href="<%= request.getContextPath()%>/client/login.jsp";
		return;
	}
